...
public:
    ...
    static constexpr std::uint16_t ADDR_MON_KEYIN  = 0xFD0Cu;
    static constexpr std::uint16_t ADDR_MON_COUT   = 0xFDEDu;
    ...
    static constexpr std::uint16_t ADDR_MON_APPLE2_RESET = 0xFA62u; // One possible RESET entry
};
