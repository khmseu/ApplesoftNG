 ...
 * 2116: b0 0a     bcs RTS         ; >= ':' (incl. lowercase/tokens) -> Not a
 * digit 2118: c9 20     cmp #' '        ; Space 211a: f0 ef     beq AS_CHRGET
 * ; Skip spaces 211c: 38        sec 211d: e9 30     sbc #'0'        ; Digit
 * check 211f: 38        sec 2120: e9 d0     sbc #$d0        ; Final range check
