...
void AS_STORE_FACDB_YX_ROUNDED() {
  ...
  destination.write(
      static_cast<std::uint8_t>(
          (ReadZeroPageByte(kAS_FAC_SIGN) | 0x7fu) &
          ReadZeroPageByte(static_cast<std::uint8_t>(kAS_FAC + 1u))),
      1u);
  destination.write(ReadZeroPageByte(static_cast<std::uint8_t>(kAS_FAC + 2u)),
                    2u);
  destination.write(ReadZeroPageByte(static_cast<std::uint8_t>(kAS_FAC + 3u)),
                    3u);
...
void AS_QINT() {
  ...
  WriteZeroPageByte(static_cast<std::uint8_t>(kAS_FAC + 1u),
                    static_cast<std::uint8_t>(packedInteger >> 24u));
  WriteZeroPageByte(static_cast<std::uint8_t>(kAS_FAC + 2u),
                    static_cast<std::uint8_t>(packedInteger >> 16u));
  WriteZeroPageByte(static_cast<std::uint8_t>(kAS_FAC + 3u),
                    static_cast<std::uint8_t>(packedInteger >> 8u));
  WriteZeroPageByte(static_cast<std::uint8_t>(kAS_FAC + 4u),
                    static_cast<std::uint8_t>(packedInteger & 0xffu));
...
void AS_NEG32768() {
  ...
  WriteZeroPageByte(static_cast<std::uint8_t>(kResult + 1u),
                    kAS_NEG32768Data[1]);
  WriteZeroPageByte(static_cast<std::uint8_t>(kResult + 2u),
                    kAS_NEG32768Data[2]);
  WriteZeroPageByte(static_cast<std::uint8_t>(kResult + 3u),
                    kAS_NEG32768Data[3]);
}
