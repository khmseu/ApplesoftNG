...
8. If storage is dual-use (integer in one path, pointer in another), use and document an explicit dual-use representation (`union`, `std::variant`, or dedicated wrapper).
